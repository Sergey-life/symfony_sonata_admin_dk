 ...
 */
final class Version20230303115953 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD code INT NOT NULL, CHANGE category_id category_id INT NOT NULL');
        $this->addSql('DROP INDEX category_id ON product');
        $this->addSql('CREATE INDEX IDX_D34A04AD12469DE2 ON product (category_id)');
        $this->addSql('ALTER TABLE product ADD CONSTRAINT product_ibfk_1 FOREIGN KEY (category_id) REFERENCES category_product (id)');
    }
